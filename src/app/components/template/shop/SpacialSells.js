...
export default function SpecialSells(){
    return(
        <div>
<div className="flex items-center justify-center gap-2 text-black/85 pb-6">
  <div className="bg-orange-100 text-orange-600 p-2.5 shadow-xl" 
       style={{ clipPath: "polygon(25% 6.7%, 75% 6.7%, 100% 50%, 75% 93.3%, 25% 93.3%, 0% 50%)" }}>
    <CiBadgeDollar size={32} />
  </div>
  <h2 className="text-xl md:text-2xl font-bold ">برگزیده ها</h2>
</div>
